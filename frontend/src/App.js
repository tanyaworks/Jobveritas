        ...
        <div style={{ background: "#0d0d0d", border: "1px solid #1a1a1a", borderRadius: 20, padding: "1.75rem", marginBottom: "1rem" }}>
          ...
          {mode === "url" ? (
            ...
            <textarea value={text} onChange={e => setText(e.target.value)}
              ...
              style={{ width: "100%", height: 180, background: "#111", border: "1px solid #1e1e1e", borderRadius: 10, color: "#ccc", fontSize: "0.92rem", resize: "vertical", outline: "none", fontFamily: "inherit", lineHeight: 1.7, padding: "1rem", marginBottom: "0.75rem" }} />
          )}
